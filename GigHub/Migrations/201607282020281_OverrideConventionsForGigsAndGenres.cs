namespace GigHub.Migrations
{
    ...
    public partial class OverrideConventionsForGigsAndGenres : DbMigration
    {
        public override void Up()
        {
            ...
            DropForeignKey("dbo.Gigs", "Type_Id", "dbo.Genres");
            DropIndex("dbo.Gigs", new[] { "Artist_Id" });
            DropIndex("dbo.Gigs", new[] { "Type_Id" });
            RenameColumn(table: "dbo.Gigs", name: "Type_Id", newName: "Genre_Id");
        ...
        public override void Down()
        {
            ...
            RenameColumn(table: "dbo.Gigs", name: "Genre_Id", newName: "Type_Id");
            CreateIndex("dbo.Gigs", "Type_Id");
            CreateIndex("dbo.Gigs", "Artist_Id");
            AddForeignKey("dbo.Gigs", "Type_Id", "dbo.Genres", "Id");
